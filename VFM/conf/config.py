...
from VFM.common.base import CN, _C
...
_C.DATASET_SOURCE.NuScenesLidarSegSCN.vfm_data_paths = ''
# 3D
...
_C.DATASET_TARGET.SemanticKITTISCN.vfm_data_paths = ''
...
_C.DATASET_SOURCE.VirtualKITTISCN.vfm_data_paths = ''
# 3D
